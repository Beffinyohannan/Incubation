                                            ...
                                            return (
                                                ...
                                                <tr>
                                                    ...
                                                    <td className='flex m-3'>
                                                        ...
                                                        <button className='border w-full  my-1 py-2 bg-indigo-600  hover:bg-indigo-500 relative text-white'  onClick={(e) => { fullDetails(obj._id) }}>Open</button>
                                                        <button className='border w-full ml-5  my-1 py-2 bg-zinc-600  hover:bg-zinc-500 relative text-white'>Approve</button>
                                                        <button className='border w-full ml-5 my-1 py-2 bg-slate-800  hover:bg-slate-600 relative text-white'>Reject</button>
                                                    </td>
